...
export default function AdminDashboard() {
  ...
  const handleAuth = (e) => {
    e.preventDefault();
    if (btoa(authInput) === "TFZfTUFTVEVSX0NPTlRST0w=") {
  ...
  const handleCreateTeam = async (e) => {
    ...
    if (!newTeamName.trim() || !newTeamCode.trim()) {
      toast.error("Name and Access Code required");
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-amber-400 font-mono p-4 selection:bg-amber-900/40">
      <header className="mb-8 border-b border-amber-900/50 pb-4 flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        {/* View Switcher */}
        <div className="flex items-center gap-2 bg-amber-950/20 p-1 rounded border border-amber-900/30">
          <Button
            onClick={() => setCurrentView("monitor")}
            variant={currentView === "monitor" ? "default" : "ghost"}
            className={`h-8 text-xs font-bold ${currentView === "monitor" ? "bg-amber-700 text-white" : "text-amber-500 hover:bg-amber-900/20 hover:text-amber-400"}`}
          >
            MONITOR
          </Button>
          <Button
            ...
            className={`h-8 text-xs font-bold ${currentView === "teams" ? "bg-amber-700 text-white" : "text-amber-500 hover:bg-amber-900/20 hover:text-amber-400"}`}
          >
            TEAM CONFIG
          </Button>
        </div>
      ...
      {currentView === "monitor" ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-amber-900/50 hover:bg-transparent">
                    ...
                    <TableHead className="text-amber-700">
                      Access Code
                    </TableHead>
                ...
                <DialogContent className="bg-black border-amber-700 text-amber-500">
                  ...
                  <div className="py-4 space-y-4">
                    ...
                    <p className="text-[10px] text-center text-amber-800 font-mono">
                      WARNING: Downgrading will reduce score by 100pts
                      instantly.
                    </p>
                  </div>
                </DialogContent>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="border border-amber-900/30 bg-black/40 rounded p-6">
            ...
            >
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-black border-amber-800 text-amber-400 font-bold"
                  placeholder="ALPHA"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-black border-amber-800 text-amber-400 font-mono"
                  placeholder="s3cret"
                />
              </div>
              <div className="flex items-end">
                <Button
                  type="submit"
                  className="w-full bg-amber-700 hover:bg-amber-600 font-bold"
                >
                  + REGISTER UNIT
                </Button>
              </div>
          ...
          <div className="border border-amber-900/30 bg-black/40 rounded p-6">
            <h2 className="text-lg font-bold mb-6 flex items-center gap-2 text-amber-400">
              <Settings className="w-5 h-5" /> MANAGE EXISTING TEAMS
            </h2>
            <Table>
              <TableHeader>
                <TableRow className="border-amber-900/50">
                  <TableHead className="text-amber-700">ID</TableHead>
                  <TableHead className="text-amber-700">Team Name</TableHead>
              ...
              <TableBody>
                {teams.map((team) => (
                  <TableRow
                    key={team.id}
                    className="border-amber-900/20 hover:bg-amber-900/5"
                  >
